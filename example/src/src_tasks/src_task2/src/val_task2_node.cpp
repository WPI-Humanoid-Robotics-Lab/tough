#include <src_task2/val_task2_node.h>
...
void task2Node::paramUpdateCallback(src_task2::task2_parametersConfig &config, uint32_t level)
{
...
int main(int argc, char** argv)
{
    ...
    dynamic_reconfigure::Server<src_task2::task2_parametersConfig> service;
    dynamic_reconfigure::Server<src_task2::task2_parametersConfig>::CallbackType callback_type;
