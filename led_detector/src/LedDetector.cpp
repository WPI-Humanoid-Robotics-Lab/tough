...
//      ,          m_multisensePcPtr(new src_perception::MultisensePointCloud(rosHandle, m_baseFrame, m_leftCameraOpticalFrame))
    {
    ...
    bool LedDetector::detectLed(){
        ...
        cv::Mat                 img_3d;
        if ((m_multisenseImagePtr == NULL) /*|| (m_multisensePc == NULL)*/)
            return false;
