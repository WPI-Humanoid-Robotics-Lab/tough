...
do
  ...
  data_log=$HOME'/indigo_ws/src/space_robotics_challenge/val_common/scripts/panel_detection/footstep_'$current_time'.log'
  ...
  roscd val_common/scripts/panel_detection
