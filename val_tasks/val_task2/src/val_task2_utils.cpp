    ...
    nh_(nh)
{
    ...
    satellite_sub_ = nh_.subscribe("/task1/checkpoint2/satellite", 10, &task2Utils::satelliteMsgCB, this);
...
void task2Utils::satelliteMsgCB(const srcsim::Satellite& msg)
{
    // update the message
    msg_ = msg;
}
...
bool task2Utils::isPitchCorrectNow(void)
{
    return msg_.pitch_correct_now;
}

bool task2Utils::isYawCorrectNow(void)
{
    return msg_.yaw_correct_now;
}

bool task2Utils::isPitchCompleted(void)
{
    return msg_.pitch_completed;
}

bool task2Utils::isYawCompleted(void)
{
    return msg_.yaw_completed;
}

double task2Utils::getPitchDiff (void)
{
    return (msg_.target_pitch - msg_.current_pitch);
}

double task2Utils::getYawDiff (void)
{
    return (msg_.target_yaw - msg_.current_yaw);
}

void task2Utils::getCircle3D(geometry_msgs::Point center, geometry_msgs::Point start, geometry_msgs::Pose pose, const std::vector<float> planeCoeffs, std::vector<geometry_msgs::Pose> &points, float radius, int steps)
{
...
void task2Utils::visulatise6DPoints(std::vector<geometry_msgs::Pose> &points)
{
