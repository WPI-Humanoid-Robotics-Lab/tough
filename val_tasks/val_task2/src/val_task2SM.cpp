    ...
    FSM_BGN // begin state machine
    {
        ...
        FSM_STATE(STATE_DETECT_ROVER)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/DETECTED_ROVER", FSM_NEXT(STATE_MANUAL_EXECUTION)) // change for automatic: STATE_WALK_TO_ROVER
        ...
        FSM_STATE(STATE_WALK_TO_ROVER)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/REACHED_ROVER", FSM_NEXT(STATE_MANUAL_EXECUTION)) // STATE_DETECT_SOLAR_PANEL
                FSM_ON_EVENT("/MANUAL_EXECUTION", FSM_NEXT(STATE_MANUAL_EXECUTION))
        ...
        FSM_STATE(STATE_DETECT_SOLAR_PANEL)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/DETECTED_PANEL", FSM_NEXT(STATE_MANUAL_EXECUTION))   /// @todo attention: STATE_GRASP_SOLAR_PANEL
        ...
        FSM_STATE(STATE_GRASP_SOLAR_PANEL)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/GRASPED_PANEL", FSM_NEXT(STATE_MANUAL_EXECUTION)) //change for automatic: STATE_PICK_SOLAR_PANEL
        ...
        FSM_STATE(STATE_PICK_SOLAR_PANEL)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/PICKED_PANEL", FSM_NEXT(STATE_MANUAL_EXECUTION)) //change for automatic: STATE_DETECT_SOLAR_ARRAY
                FSM_ON_EVENT("/MANUAL_EXECUTION", FSM_NEXT(STATE_MANUAL_EXECUTION))
            }
        }
        FSM_STATE(STATE_DETECT_SOLAR_ARRAY)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/DETECTED_ARRAY", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_WALK_TO_SOLAR_ARRAY
        ...
        FSM_STATE(STATE_WALK_TO_SOLAR_ARRAY)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/REACHED_ARRAY", FSM_NEXT(STATE_MANUAL_EXECUTION)) //change for automatic: STATE_ROTATE_PANEL
...
//                FSM_ON_EVENT("/ROTATE_PANEL_RETRY", FSM_NEXT(STATE_ROTATE_PANEL))
                FSM_ON_EVENT("/ROTATED_PANEL", FSM_NEXT(STATE_MANUAL_EXECUTION)) //change for automatic: STATE_FIND_CABLE_INTERMEDIATE
//                FSM_ON_EVENT("/ROTATE_PANEL_FAILED", FSM_NEXT(STATE_ERROR))
        ...
        FSM_STATE(STATE_FIND_CABLE_INTERMEDIATE)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/FOUND_CABLE", FSM_NEXT(STATE_MANUAL_EXECUTION)) //change for automatic: STATE_DETECT_SOLAR_ARRAY_FINE
        ...
        FSM_STATE(STATE_DETECT_SOLAR_ARRAY_FINE)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/DETECTED_ARRAY_FINE", FSM_NEXT(STATE_MANUAL_EXECUTION)) //change for automatic: STATE_ALIGN_TO_SOLAR_ARRAY
        ...
        FSM_STATE(STATE_ALIGN_TO_SOLAR_ARRAY)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/ALIGNED_TO_ARRAY", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_PLACE_SOLAR_PANEL_ON_GROUND
        ...
        FSM_STATE(STATE_PLACE_SOLAR_PANEL_ON_GROUND)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/PLACED_ON_GROUND", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_DETECT_DEPLOY_PANEL_BUTTON
        ...
        FSM_STATE(STATE_DETECT_DEPLOY_PANEL_BUTTON)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/BUTTON_DETECTED", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_DEPLOY_SOLAR_PANEL
        ...
        FSM_STATE(STATE_DEPLOY_SOLAR_PANEL)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/DEPLOYED", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_DETECT_POWER_CABLE
        ...
        FSM_STATE(STATE_DETECT_POWER_CABLE)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/DETECTED_CABLE", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_PICKUP_POWER_CABLE
        ...
        FSM_STATE(STATE_PICKUP_POWER_CABLE)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/CABLE_PICKED", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_DETECT_SOCKET
        ...
        FSM_STATE(STATE_PLUGIN_POWER_CABLE)
        {
            ...
            FSM_TRANSITIONS
            {
                ...
                FSM_ON_EVENT("/CABLE_PLUGGED", FSM_NEXT(STATE_MANUAL_EXECUTION))   //change for automatic: STATE_DETECT_FINISH
        ...
        FSM_STATE(STATE_DETECT_FINISH)
        {
          ...
          FSM_TRANSITIONS
          {
            ...
            FSM_ON_EVENT("/DETECT_FINISH_SUCESSFUL", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_WALK_TO_FINISH
            FSM_ON_EVENT("/MANUAL_EXECUTION", FSM_NEXT(STATE_MANUAL_EXECUTION))
          }
        }
        FSM_STATE(STATE_WALK_TO_FINISH)
        {
          ...
          FSM_TRANSITIONS
          {
            ...
            FSM_ON_EVENT("/WALK_TO_FINISH_SUCESSFUL", FSM_NEXT(STATE_MANUAL_EXECUTION))  //change for automatic: STATE_END
            FSM_ON_EVENT("/MANUAL_EXECUTION", FSM_NEXT(STATE_MANUAL_EXECUTION))
          }
        }
        FSM_STATE(STATE_END)
