  ...
  FSM_BGN // begin state machine
  {
    ...
    FSM_STATE(STATE_WALK_TO_PANEL)
    {
      ...
      FSM_TRANSITIONS
      {
        ...
        FSM_ON_EVENT("/REACHED_PANEL_FINE", FSM_NEXT(STATE_ADJUST_ARMS))
      }
    }
    FSM_STATE(STATE_ADJUST_ARMS)
    {
      ...
      FSM_TRANSITIONS
      {
        ...
        FSM_ON_EVENT("/ADJUST_ARMS_FAILED", FSM_NEXT(STATE_DETECT_PANEL_COARSE))
    ...
    FSM_STATE(STATE_CORRECT_PITCH)
    {
      ...
      FSM_TRANSITIONS
      {
        ...
        FSM_ON_EVENT("/PITCH_CORRECTION_FAILED", FSM_NEXT(STATE_DETECT_PANEL_COARSE))
