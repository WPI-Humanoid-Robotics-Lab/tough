...
def walkTest():
    ...
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.2, -0.04, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.4, -0.12, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.8, -0.10, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.2, -0.18, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [2.6, -0.16, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.85, -0.20, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [2.85, -0.18, 0.0]))

    #walk through the door (hard coded steps, left algined)
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.0, 0.19, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.0, 0.17, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.4, 0.19, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.8, 0.17, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.2, 0.19, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.6, 0.17, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.6, 0.19, 0.0]))
