...
def walkTest():
    ...
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.0, 0.06, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.0, 0.06, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.0, 0.12, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.0, 0.12, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.0, 0.19, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.0, 0.19, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.2, 0.0, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.4, 0.0, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.6, 0.0, 0.0]))
    # msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.8, 0.0, 0.0]))
