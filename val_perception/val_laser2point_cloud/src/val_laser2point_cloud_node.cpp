...
int main(int argc, char** argv){
    ...
    ros::NodeHandle n;
    Laser2PointCloud laser2point(n, PERCEPTION_COMMON_NAMES::MULTISENSE_LASER_SCAN_TOPIC, DESCRIPTION_COMMON_NAMES::L_FOOT_TF, PERCEPTION_COMMON_NAMES::MULTISENSE_LASER_CLOUD_TOPIC);
