 ...
 */
/*
* The objective of this class is to act as the interface between the multisense ros datatypes with the standard PCL data
* structures
...
class MultisensePointCloud
{
  ...
  std::string laser_topic_, stereo_topic_;
