...
namespace PERCEPTION_COMMON_NAMES
{
    ...
    static const std::string ASSEMBLED_LASER_CLOUD_TOPIC = "/field/assembled_cloud2";
    static const std::string ASSEMBLED_LASER_CLOUD_TOPIC_FOR_OCTOMAP = "/field/assembled_octomap_cloud2";
