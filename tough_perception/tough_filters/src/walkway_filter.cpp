...
WalkwayFilter::WalkwayFilter(ros::NodeHandle& n) : nh_(n)
{
  ...
  pointcloudSub_ = nh_.subscribe(PERCEPTION_COMMON_NAMES::ASSEMBLED_LASER_CLOUD_TOPIC_FOR_OCTOMAP, 1,
                                 &WalkwayFilter::generateMap, this);
...
void WalkwayFilter::subtractPointClouds(pcl::PointCloud<pcl::PointXYZ>::Ptr full_cloud,
                                        const pcl::PointIndices::Ptr outliers)
{
