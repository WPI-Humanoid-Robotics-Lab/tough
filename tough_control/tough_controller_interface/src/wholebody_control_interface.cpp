...
bool WholebodyControlInterface::validateJointSequenceInTrajectory(const std::vector<std::string> &traj_joint_names, const std::vector<std::string> &joint_names, long start) {
