...
// EXPECT_EQ and ASSERT_EQ are also macros—in the former case test execution continues even if there is a failure while
// in the latter case test execution aborts
