...
#include <tough_footstep/StepTargetArray.h>
...

{
  ...
  // ros::Publisher footStep_publish = n.advertise < std::vector <humanoid_nav_msgs::StepTarget > >("footStep_pub",
  // 50,true);
  // std::vector <humanoid_nav_msgs::StepTarget , 10 > a;

  // humanoid_nav_msgs::StepTarget p [5];

  ros::Publisher footStep_pub = n.advertise<tough_footstep::StepTargetArray>("footStep_pub", 50, true);
  /*
 */
  ...
  tough_footstep::StepTargetArray result;
