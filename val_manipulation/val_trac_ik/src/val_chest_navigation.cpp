#include <val_manipulation/val_chest_navigation.h>

const double halfC = M_PI / 180;
chestTrajectory::chestTrajectory(ros::NodeHandle nh):nh_(nh)
{
    chestTrajPublisher = nh_.advertise<ihmc_msgs::ChestTrajectoryRosMessage>("/ihmc_ros/valkyrie/control/chest_trajectory",1,true);
}
